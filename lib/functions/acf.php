...
// filter current opportunities to only show published
add_filter('acf/fields/relationship/query/name=opportunities_posts', 'relationship_options_filter', 10, 3);
// filter news & events to only show published
add_filter('acf/fields/relationship/query/name=opportunities_posts', 'relationship_options_filter', 10, 3);
